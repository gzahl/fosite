...
CONTAINS
  ...
  REAL FUNCTION f_x(p, rho_x, u_x, p_x, A_x, B_x, c_x)
    IMPLICIT NONE
    !----------------------------------------------------------------------!
